  ...
  public function buildFieldDefinitions() {
    ...
    $field_info = [
        'csc_farm_summary_fiscal_year' => [
          ...
          'csc_farm_summary_fiscal_quarter' => [
            'type' => 'string',
          ...
          'csc_farm_summary_incentive_type' => [
            'type' => 'entity_reference',
